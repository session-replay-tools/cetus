...
NETWORK_API int network_mysqld_proto_get_com_query_result(network_packet *packet, 
        network_mysqld_com_query_result_t *udata, gboolean use_binary_row_data);
...
NETWORK_API int network_mysqld_com_init_db_result_track_state(network_packet *, 
        network_mysqld_com_init_db_result_t *);
NETWORK_API int network_mysqld_proto_get_com_init_db_result(network_packet *, 
        network_mysqld_com_init_db_result_t *, network_mysqld_con *);
...
NETWORK_API network_mysqld_auth_challenge *
network_mysqld_auth_challenge_copy(const network_mysqld_auth_challenge *);
...
NETWORK_API int network_mysqld_proto_get_and_change_auth_response(network_packet *, 
...
NETWORK_API int network_mysqld_proto_change_stmt_id_from_ok_packet(network_packet *packet,
                                                                   int server_index);
