...
NETWORK_API int network_mysqld_proto_get_fielddef(network_packet *packet, 
...
NETWORK_API int network_mysqld_proto_append_lenenc_str_len(GString *packet, 
        const char *s, guint64 len);
